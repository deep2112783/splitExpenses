...
const FormLabel = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => {
    ...
    return /*#__PURE__*/_jsx(Label, { ref: ref, className: cn(error && "text-destructive", className), htmlFor: formItemId, ...props });
  });
...
const FormDescription = /*#__PURE__*/React.forwardRef(
  ({ className, ...props }, ref) => {
    ...
    return /*#__PURE__*/_jsx("p", { ref: ref, id: formDescriptionId, className: cn("text-sm text-muted-foreground", className), ...props });
  }
);
