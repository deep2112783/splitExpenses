...
const ScrollArea = /*#__PURE__*/React.forwardRef(
  ...
  _jsxs(ScrollAreaPrimitive.Root, { ref: ref, className: cn("relative overflow-hidden", className), ...props, children: [/*#__PURE__*/
    _jsx(ScrollAreaPrimitive.Viewport, { className: "h-full w-full rounded-[inherit]", children: children }), /*#__PURE__*/
